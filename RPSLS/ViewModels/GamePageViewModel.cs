...
namespace RPSLS.ViewModels
{
    internal class GamePageViewModel : ViewModelBase
    {
        ...
        private ICommand _rockCommand, _paperCommand, _scissorsCommand, _lizardCommand, _spockCommand;

        public ICommand RockCommand
        {
            get
            {
                if (_rockCommand == null)
                {
                    _rockCommand = new RelayCommand(param => Play(Element.Rock),
                        null);
                }
                return _rockCommand;
            }
        ...
        public ICommand PaperCommand
        {
            get
            {
                if (_paperCommand == null)
                {
                    _paperCommand = new RelayCommand(param => Play(Element.Paper),
                        null);
                }
        ...
        public ICommand ScissorsCommand
        {
            get
            {
                if (_scissorsCommand == null)
                {
                    _scissorsCommand = new RelayCommand(param => Play(Element.Scissors),
                        null);
                }
                return _scissorsCommand;
            }
        }

        public ICommand LizardCommand
        {
            get
            {
                if (_lizardCommand == null)
                {
                    _lizardCommand = new RelayCommand(param => Play(Element.Lizard),
                        null);
                }
                return _lizardCommand;
            }
        }

        public ICommand SpockCommand
        {
            get
            {
                if (_spockCommand == null)
                {
                    _spockCommand = new RelayCommand(param => Play(Element.Spock),
                        null);
                }
                return _spockCommand;
            }
        }
    }
}